...
function Sides({navigation, route,test}){
  const arrayOfSides = []
  test.filter(sides=>sides.category === "Sides").map((results)=>{
     arrayOfSides.push(results);
  })
                      ...
                      <Pressable onPress={()=>navigation.navigate('addToCart',{
                        ...
                        itemAmount: item.amount
                           ...
                           <View style={[styles.itemContainer]}>
                                      <View style={{backgroundColor:'white', height:100,borderRadius: 15}}>
